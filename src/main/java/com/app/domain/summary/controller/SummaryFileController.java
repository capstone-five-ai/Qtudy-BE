...
public class SummaryFileController {
    ...
    public ResponseEntity<String> AiGenerateSummaryFileByText(@RequestHeader("Authorization") String token, @Valid @RequestBody AiGenerateSummaryByTextDto aiGenerateSummaryByTextDto) {
    ...
    public ResponseEntity<String> AiGenerateSummaryImageByImage(@RequestHeader("Authorization") String token, @RequestParam("file") List<MultipartFile> imageFile, @ModelAttribute AiGenerateSummaryByFileDto aiGenerateSummaryByFileDto) {
    ...
    public ResponseEntity<String> AiGenerateSummaryFileByPdf(@RequestHeader("Authorization") String token, @RequestParam("file") MultipartFile pdfFile, @ModelAttribute AiGenerateSummaryByFileDto aiGenerateSummaryByFileDto) {
